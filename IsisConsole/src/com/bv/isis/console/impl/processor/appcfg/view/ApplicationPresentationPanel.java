...
* ------------------------------------------------------------
*
* $Source: /cvs/inuit/ClientHMI/src/com/bv/isis/console/impl/processor/appcfg/view/ApplicationPresentationPanel.java,v $
* $Revision: 1.2 $
*
* ------------------------------------------------------------
 ...
 * ------------------------------------------------------------*/
public class ApplicationPresentationPanel extends AbstractPanel {
	 ...
	 * ------------------------------------------------------------*/
	public ApplicationPresentationPanel(WindowInterface mainWindow) {
		super();
	...
	private void makePanel(){
		...
		_firstDescriptionSentence.setText(
			MessageManager.getMessage("&AppCfg_Welcome"));
		...
		_secondDescriptionSentence.setText(
			MessageManager.getMessage("&AppCfg_ClickNext1"));
		...
		_thirdDescriptionSentence.setText(
			MessageManager.getMessage("&AppCfg_ClickNext2"));
