...
* ------------------------------------------------------------
*
* $Source: /cvs/inuit/ClientHMI/src/com/bv/isis/console/core/gui/SearchableTextPane.java,v $
* $Revision: 1.3 $
*
* ------------------------------------------------------------
...
*
* $Log: SearchableTextPane.java,v $
* Revision 1.3  2009/01/14 14:19:23  tz
...
/*----------------------------------------------------------
* Nom: SearchableTextPane
* 
* Description:
* Cette classe est une spécialisation de la classe JTextPane afin de créer 
* une zone de texte dans laquelle l'utilisateur peut effectuer des recherches 
* de chaînes de caractères, ou sauvegarder les données dans des fichiers.
	...
	implements SearchableComponentInterface
{
 	...
 	* ----------------------------------------------------------*/
 		...
 		)
 	{
		...
		Trace trace_methods = TraceAPI.declareTraceMethods("Console",
			"SearchableTextPane", "SearchableTextPane");
	...
	* ----------------------------------------------------------*/
	...
	{
		Trace trace_methods = TraceAPI.declareTraceMethods("Console",
			"SearchableTextPane", "searchAgain");
		Trace trace_arguments = TraceAPI.declareTraceArguments("Console");
		boolean found = false;
	...
	* ----------------------------------------------------------*/
	...
	{
		Trace trace_methods = TraceAPI.declareTraceMethods("Console",
			"SearchableTextPane", "setLastSearchPosition");
		Trace trace_arguments = TraceAPI.declareTraceArguments("Console");
	...
	* ----------------------------------------------------------*/
	...
	{
		Trace trace_methods = TraceAPI.declareTraceMethods("Console",
			"SearchableTextPane", "getLastSearchPosition");
	...
	* ----------------------------------------------------------*/
	...
	{
		Trace trace_methods = TraceAPI.declareTraceMethods("Console",
			"SearchableTextPane", "saveToDataFile");
		Trace trace_arguments = TraceAPI.declareTraceArguments("Console");
	...
	* Retourne: Un tableau vide.
 	* ----------------------------------------------------------*/
 	public FileFilter[] getFileFilters() {
		Trace trace_methods = TraceAPI.declareTraceMethods("Console",
			"SearchableTextPane", "getFileFilters");
