...
# Open
############
my $table_sqlite = Sqlite->open('D:\program files\BV Associates\I-SIS V2.0.2\Agent\ICles\IKOS\V0\Core\tab\IKOS_TEST_TEST.sqlite',"TEST", { debug => 0, timeout => 1000});
...
# Open
############
my $histo_table= Histo->open('D:\program files\BV Associates\I-SIS V2.0.2\Agent\ICles\IKOS\V0\Core\tab\IKOS_TEST_TEST.sqlite',"TEST", { debug => 0, timeout => 10000});
